       ...
       <div class="container" align="center">
        <div class="col-md-12">
           ...
           if($erro == 1){
           	...
           	?><h3 class="color-msg">Registo realizado com sucesso !!</h3><?php 
           }
           ?>
           <div class="faixa-2"></div><br/>
           <button onclick="window.location.href = 'home_professor.php'" class="btn btn-default btne">Voltar</button>
        </div>
       </div> 
     </div>
   </div>
