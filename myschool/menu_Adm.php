...
<body>
    ...
    <div class="w3-sidebar w3-light-grey w3-bar-block" style="width:20%">
    	<h3 class="w3-bar-item">Menu Administrativo</h3>
     
      <a href="solicitacao_user.php" class="w3-bar-item w3-button btn_style">Solicitação de cadastro</a>

      <a href="cadastrarAlunoMateria.php" class="w3-bar-item w3-button btn_style">Cadastrar aluno na matéria</a>

      
      <a href="cadastro_curso.php" class="w3-bar-item w3-button btn_style">Cadastro curso</a>

      <a href="cadastro_semestre.php" class="w3-bar-item w3-button btn_style">Cadastro semestre</a>


      <a href="cadastro_materia.php" class="w3-bar-item w3-button btn_style">Cadastro matéria</a>

      <a href="cadastro_professor.php" class="w3-bar-item w3-button btn_style">Cadastro professor</a>

      <a href="comunicado.php" class="w3-bar-item w3-button btn_style">Comunicado</a>
