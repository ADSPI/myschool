			...
			<table class="table table-striped table-bordered table-hover table-condensed botao">
				<thead>
					...
					<tbody>
						...
						<tr class="warning">
							<td><a href="visualizar_nota_materia.php?materia=<?php echo $resultado_query_aluno_materias['id_materia']; ?>"><?php echo $resultado_query_aluno_materias['nome_materia'] ?></a></td>
						</tr><?php
					   }?>
					</tbody>
				</thead>
